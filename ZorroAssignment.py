...
'''
	Look into images: ARR.png, ssim.png, mean.png, and mean_inv.png (This one is inversed and rotated)

	The large spikes are changes in frames, which can denote a change in scene
	
	One anomaly is towards the end, where the group is running.
	This scene causes a lot of flux.
	
	Attaching folder of imagse of the changing scenes.
